...
function About() {
  return (
    <div className="relative flex items-center justify-center w-screen h-full mx-auto bg-[#141414]">
      <div className="flex flex-col items-center justify-center w-10/12 gap-16 py-20">
        <Image src={Logo} alt="Logo" className="sm:w-1/2" />
        <h1
          className="w-full text-center text-white xl:text-5xl lg:text-4xl text-xl leading-10 md:leading-10 md:text-3xl font-normal font-['Gilroy'] 2xl:leading-[80px] xl:leading-[60px] inline-block"
        >
